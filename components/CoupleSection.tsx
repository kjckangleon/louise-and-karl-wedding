    ...
    <SectionWrapper id="our-story" title="Our Story">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="relative h-96 lg:h-[500px] rounded-lg shadow-xl overflow-hidden group">
          <img src="https://picsum.photos/800/600?random=1" alt="The Couple" className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500" />
